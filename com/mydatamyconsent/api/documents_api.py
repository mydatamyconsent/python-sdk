...
class DocumentsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.issue_document = _Endpoint(
            ...
            callable=__issue_document
        )

        def __v1_documents_issued_document_id_get(
            self,
            document_id,
            **kwargs
        ):
        ...
        self.v1_documents_issued_document_id_get = _Endpoint(
            settings={
                'response_type': None,
                'auth': [],
            ...
            api_client=api_client,
            callable=__v1_documents_issued_document_id_get
        )

        def __v1_documents_issued_get(
            self,
            **kwargs
        ):
        ...
        self.v1_documents_issued_get = _Endpoint(
            settings={
                'response_type': None,
                'auth': [],
            ...
            api_client=api_client,
            callable=__v1_documents_issued_get
        )

        def __v1_documents_types_get(
            self,
            **kwargs
        ):
        ...
        self.v1_documents_types_get = _Endpoint(
            settings={
                'response_type': None,
                'auth': [],
            ...
            api_client=api_client,
            callable=__v1_documents_types_get
        )
