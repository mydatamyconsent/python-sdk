...
class DataConsent(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'documents': ([DataConsentDocument], none_type,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, request_id, title, description, status, approved_at_utc, data_access_expires_at_utc, collectables, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            identifiers (bool, date, datetime, dict, float, int, list, str, none_type): Consented identity details.. [optional]  # noqa: E501
            documents ([DataConsentDocument], none_type): List of consented documents.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, request_id, title, description, status, approved_at_utc, data_access_expires_at_utc, collectables, *args, **kwargs):  # noqa: E501
        """DataConsent - a model defined in OpenAPI
