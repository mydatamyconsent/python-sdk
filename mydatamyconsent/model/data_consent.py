...
class DataConsent(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, title, description, status, approved_at_utc, data_access_expires_at_utc, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, title, description, status, approved_at_utc, data_access_expires_at_utc, *args, **kwargs):  # noqa: E501
        """DataConsent - a model defined in OpenAPI
