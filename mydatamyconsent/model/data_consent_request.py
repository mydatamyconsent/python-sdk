...
class DataConsentRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, title, description, collectables, status, created_at_utc, expires_at_utc, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, title, description, collectables, status, created_at_utc, expires_at_utc, *args, **kwargs):  # noqa: E501
        """DataConsentRequest - a model defined in OpenAPI
