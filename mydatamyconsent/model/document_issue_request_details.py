...
class DocumentIssueRequestDetails(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, document_type_id, document_type_name, document_identifier, description, receiver, created_at_utc, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, document_type_id, document_type_name, document_identifier, description, receiver, created_at_utc, *args, **kwargs):  # noqa: E501
        """DocumentIssueRequestDetails - a model defined in OpenAPI
