...
class FinancialAccountTypes(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """FinancialAccountTypes - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str):, must be one of ["SavingsBankAccount", "MutualFund", "EquityShare", "NationalPensionScheme", "InsurancePolicy", "Demat", "CreditCard", "Loan", "Bond", "Debenture", "Deposit", "GovernmentSecurity", "IndianDepositoryReceipt", "Invit", "Reit", "PublicProvidentFund", "SystematicInvestmentPlan", "TermDeposit", "UnitLinkedInsurancePlan", "RecurringDeposit", "AlternativeInvestmentFund", "CreditScoreReport", ]  # noqa: E501
