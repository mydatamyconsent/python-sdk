...
def lazy_import():
    ...
    globals()['DocumentReceiver'] = DocumentReceiver


class IssuedDocumentDetails(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, identifier, document_type, issued_to, issued_at_utc, receiver, digital_signatures, *args, **kwargs):  # noqa: E501
        """IssuedDocumentDetails - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, identifier, document_type, issued_to, issued_at_utc, receiver, digital_signatures, *args, **kwargs):  # noqa: E501
        """IssuedDocumentDetails - a model defined in OpenAPI
